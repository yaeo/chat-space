...
$(function() {
  ...
  function appendList(user) {
    var item = $("<div class= 'chat-group-user clearfix'>")
               .append("<p class='chat-group-user__name'>"+user.name+"</p> \
               <a \
               class='user-search-add chat-group-user__btn chat-group-user__btn--add' \
